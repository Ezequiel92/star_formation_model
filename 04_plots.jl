...
let
	...
	# Mass recycling fraction
	ZSN(Z) = MODEL.compute_recycled_fractions(Z * MODEL.Zsun)[2]
	
	with_theme(THEME) do

		f = Figure(size=(800, 2800))
		...
		#################################
		# Metals recycling fraction plot
		#################################
...
manifest_format = "2.0"
project_hash = "99ee22e8a3fad5eafa0b82a288db3d5af3a8d9ab"
