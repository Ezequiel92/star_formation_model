...
####  Usage Contexts for Each Source

*   **Christensen et al. (2012) & Gnedin et al. (2009):** These authors assume a log-normal density substructure on scales smaller than gas particles. A clumping factor of **10** is used to boost the H$_2$ formation rate, accounting for the fact that H$_2$ forms much faster in dense, unresolved regions than it would in a uniform medium.
*   **Trayford et al. (2025):** This source uses a **density-dependent clumping factor** (rising from 1 to 100) to boost the rates of dust accretion and coagulation. It accounts for the inability of cosmological simulations to resolve the dense cores of molecular clouds where dust grows most efficiently.
*   **Micic et al. (2012):** This study tests the H$_2$ formation models used in large-scale simulations (like Gnedin et al. 2009). They find that while using a clumping factor of **3–10** works well when H$_2$ fractions are small, the approach can overpredict formation rates once high-density gas becomes fully molecular.



We find that a clumping factor of $C_\rho \approx 100$ is required to form a disk.
"""
...
manifest_format = "2.0"
project_hash = "eb3d04b079c7de02265c6325940a532f79e0dc5e"
...
git-tree-sha1 = "368d9af882e7e696e89ad8d34b776cc242900726"
