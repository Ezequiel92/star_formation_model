...
let
	using Measurements, Libdl, Printf, PlutoLinks, Statistics, StatsBase, OrdinaryDiffEqRosenbrock, OrdinaryDiffEqSDIRK, OrdinaryDiffEqBDF, OrdinaryDiffEqNordsieck
...
function c_solver_generator()::Function
	...
	return CODEGEN.integrate_with_c(
		...
		Libdl.dlopen("./generated_files/c_files/lib.so"),
	)
...
manifest_format = "2.0"
project_hash = "7b0e6232fb61f9505e807b2041cc6f0f7b3bf9a2"
